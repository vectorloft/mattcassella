...
$wpdb->add_database(array(
	'host'     => getenv("MYSQL_HOST"),     // If port is other than 3306, use host:port.
...
if(getenv("MYSQL_HOST2")){
	$wpdb->add_database(array(
		'host'     => getenv("MYSQL_HOST2"),     // If port is other than 3306, use host:port.
		'user'     => getenv("MYSQL_USER2"),
		'password' => getenv("MYSQL_PASS2"),
		'name'     => DB_NAME,
		'write'    => 0,
		'read'     => 1,
		'dataset'  => 'global',
